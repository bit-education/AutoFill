...
def generate_messages(chunk, previous_messages=None):
    ...
    if previous_messages:
        _messages = [
            {"role": "system",
             "content": "You are an expert at parsing the structure of application forms and filling instructions from HTML content. Be careful not to parse the missing elements. Remember the previous parsed information."},
            {"role": "user",
             "content": f"Previous parsed information:{previous_messages}\nHTML content is:{chunk}"}
        ]
